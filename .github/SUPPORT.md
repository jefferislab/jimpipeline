# Getting help with jimpipeline

Thanks for using jimpipeline. We're sorry if you're having trouble, but don't worry,
...
* Search GitHub for [_issues_ with the jimpipeline package](https://github.com/natverse/jimpipeline/issues).
...
* If you need to report a *new* bug:
  please [file an issue](https://github.com/natverse/jimpipeline/issues/new).
* If you're not sure:
